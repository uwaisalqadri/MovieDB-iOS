...
class CastCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        castImage.layer.cornerRadius = frame.width/2.4
                
        castImage.anchor(top: topAnchor, leading: leadingAnchor, bottom: castName.topAnchor, trailing: trailingAnchor, padding: .init(top: 0, left: 10, bottom: 0, right: 10), size: .init(width: 125, height: 125))
